...
scaled_x = tf.sin(tf.linspace(0, 2, 150) * math.pi) # Scale x by cos

noise = tf.tensordot(scaled_x, x, axes=0)
...
pics[0].save("sine.gif", save_all=True, append_images=pics[1:], loop=0, duration = 100,)
