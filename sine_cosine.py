...
noise = tf.add(tf.tensordot(scaled_x, x, axes=0), tf.tensordot(scaled_y, x, axes=0)) # Total noise sum
...
pics[0].save("sine_cosine.gif", save_all=True, append_images=pics[1:], loop=0, duration = 100,)
